"""
Robust WebSocket Test for ProAPI

This example demonstrates the WebSocket functionality in ProAPI with a fixed ASGI adapter.
It includes both an echo server and a chat room with improved error handling.
"""
...
async def chat_room(websocket, room):
    ...
    try:
        ...
        while True:
            ...
            for conn in list(chat_rooms[room]):  # Create a copy of the list to avoid modification during iteration
                if conn.closed:
...
if __name__ == "__main__":
    print("Robust WebSocket Test for ProAPI")
    print()
