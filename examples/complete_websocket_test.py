...
def index(request):
    return {
        "message": "Complete WebSocket Test",
        "endpoints": {
...
if __name__ == "__main__":
    print("Complete WebSocket Test for ProAPI")
    print()
