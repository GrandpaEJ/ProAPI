"""
Login Example for ProAPI (Clean Logging Version)
...
- User management
- Clean, organized logging like Flask

To run this example:
    python login_example_clean.py
...
if __name__ == "__main__":
    ...
    logger.info("Login Example running at http://localhost:8000/")
    ...
    try:
        ...
        set_app(app)
        logger.info("Using fixed ASGI adapter")
    except ImportError:
