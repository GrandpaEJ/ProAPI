"""
Fixed WebSocket Test for ProAPI

This is a minimal example to test WebSocket functionality in ProAPI with a fixed ASGI adapter.
"""
...
def client(request):
    ...
    <html>
    <head>
        <title>Fixed WebSocket Test</title>
        <style>
...
if __name__ == "__main__":
    print("Fixed WebSocket Test for ProAPI")
    print()
