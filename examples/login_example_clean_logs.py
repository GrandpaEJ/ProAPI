"""
Login Example for ProAPI (Clean Logs Version)
...
To run this example:
    python login_example_clean_logs.py
...
from proapi.logging import app_logger
...
if __name__ == "__main__":
    # Print important information first in a clean format
    print("\n=== ProAPI Login Example ===")
